...
class DiscountAdmin(ModelView, model=Discount):
    ...
    column_list = [Discount.id, Discount.name, Discount.discount_type, Discount.value, Discount.scope, Discount.campaign_id, Discount.is_active, Discount.start_date, Discount.end_date, Discount.priority]
    column_details_list = [Discount.id, Discount.name, Discount.discount_type, Discount.value, Discount.scope, Discount.campaign_id, Discount.product_id, Discount.category_id, Discount.product_type, Discount.start_date, Discount.end_date, Discount.is_active, Discount.priority, Discount.created_at, Discount.updated_at]
    ...
    form_columns = [Discount.name, Discount.discount_type, Discount.value, Discount.scope, Discount.campaign, Discount.product, Discount.category, Discount.product_type, Discount.start_date, Discount.end_date, Discount.is_active, Discount.priority]
    form_ajax_refs = {
        "campaign": {
            "fields": ("name", "id"),
            "order_by": "name",
